...
RUN . /etc/environment && echo -e "\n\e[1;32mRun the following line to copy your OpenRV build into your ~/Downloads folder:\e[0m" && \
    echo -e "\e[1;36msudo docker cp openrv_build:/OpenRV/${BUILD_NAME}.tar.gz ~/Downloads/\e[0m\n\n"
