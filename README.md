...
Run these command to create an insall of open RV.  Note you must have docker installed. This will create the file "OpenRV-Rocky9-x86_64-2.0.0.tar.gz" in the same directory that has a working copy of RV.
```
